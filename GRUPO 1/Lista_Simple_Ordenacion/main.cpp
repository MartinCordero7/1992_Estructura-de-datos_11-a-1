...
int main()
{
    ...
    do
    {
        ...
        cout << "9. Ordenar lista por cédula\n";
        cout << "10. Salir\n";
        ...
        case 8:
            ...
            break;
        case 9:
        { // Ordenar lista usando Radix Sort externo
            string archivoEntrada = "C:/Users/alejo/Programas U/3. ListaSimple/registros_originales.txt";
            string archivoSalida = "C:/Users/alejo/Programas U/3. ListaSimple/registros_ordenados.txt";

            // Guardar la lista actual en el archivo de entrada
            listaOriginal.guardarEnArchivo(archivoEntrada);

            // Ejecutar Radix Sort externo
            listaOriginal.radixSortExterna(archivoEntrada, archivoSalida);

            cout << "Registros ordenados y guardados en " << archivoSalida << endl;
            break;
        }
