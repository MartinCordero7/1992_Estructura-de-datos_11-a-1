...
bool Validaciones::validarFecha(const string& fecha) {
    ...
    if (!regex_match(fecha, formatoFecha)) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El formato de la fecha debe ser DD-MM-YYYY.\n";
        return false;
    }
    ...
    if (anio <= 1900 || mes < 1 || mes > 12 || dia < 1 || dia > diasEnMes(mes, anio)) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: Fecha no válida.\n";
        return false;
    }
    ...
    if (anio > anioActual || (anio == anioActual && mes > mesActual) || (anio == anioActual && mes == mesActual && dia > diaActual)) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: La fecha no puede ser mayor a la fecha actual.\n";
        return false;
    }
    ...
    if (anio > anioActual - 5 || (anio == anioActual - 5 && (mes > mesActual || (mes == mesActual && dia > diaActual)))) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: La fecha de nacimiento debe ser al menos 5 años antes de la fecha actual.\n";
        return false;
    }
...
bool Validaciones::validarTituloNombre(const string& texto, const string& campo) {
    ...
    if (texto.empty() || texto.find_first_not_of(' ') == string::npos) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El campo " << campo << " no puede estar vacío o contener solo espacios.\n";
        return false;
    } else if (!regex_match(texto, formatoTituloNombre)) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El campo " << campo << " debe comenzar con una letra mayúscula y las demás minúsculas.\n";
        return false;
    }
    return true;
}
...
bool Validaciones::validarTitulo(const string& texto, const string& campo) {
    ...
    if (texto.empty() || texto.find_first_not_of(' ') == string::npos) {
        ...
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El campo " << campo << " debe comenzar con una letra mayúscula, número o carácter especial permitido y cada palabra debe tener al menos una letra.\n";
        return false;
    }
    ...
    while (ss >> palabra) {
        if (!isupper(palabra[0]) && !isdigit(palabra[0])) {
            cout << "\033[A\33[2K\r\033[A\33[2K\rError: Cada palabra debe comenzar con una letra mayúscula o un número.\n";
            return false;
        }
        for (size_t i = 1; i < palabra.size(); ++i) {
            if (!islower(palabra[i]) && !isdigit(palabra[i]) && palabra[i] != '#' && palabra[i] != '+' && palabra[i] != '-') {
                cout << "\033[A\33[2K\r\033[A\33[2K\rError: Las letras después de la primera deben ser minúsculas o caracteres especiales permitidos.\n";
                return false;
            }
        }
    }
...
bool Validaciones::validarFechaPublicacion(const string& fechaPub, const string& fechaNacAutor) {
    try {
        ...
        if (diferenciaAnios < 4) {
            cout << "\033[A\33[2K\r\033[A\33[2K\rError: La fecha de publicación debe ser al menos 4 años posterior al año de nacimiento del autor (" 
        ...
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: " << e.what() << endl;
        return false;
    }
}
...
bool Validaciones::validarIsbn(const string& isbn) {
    if (isbn.empty()) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El ISBN no puede estar vacío.\n";
        return false;
    }

    // Validar formato de guiones
    if (isbn.front() == '-' || isbn.back() == '-') {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El ISBN no puede comenzar ni terminar con un guion.\n";
        return false;
    }

    if (isbn.find("--") != string::npos) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El ISBN no puede contener guiones consecutivos.\n";
        return false;
    }
    ...
    if (all_of(isbnSinGuiones.begin(), isbnSinGuiones.end(), [isbnSinGuiones](char c) { return c == isbnSinGuiones[0]; })) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El ISBN no puede contener todos los caracteres iguales.\n";
        return false;
    }
    ...
    cout << "\033[A\33[2K\r\033[A\33[2K\rError: El ISBN debe tener 10 o 13 caracteres (sin contar los guiones).\n";
    return false;
}

bool Validaciones::validarIsbn10(const string& isbn) {
    if (isbn.size() != 10) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El ISBN debe tener 10 caracteres.\n";
        return false;
    }
    ...
    for (int i = 0; i < 9; i++) {
        if (!isdigit(isbn[i])) {
            cout << "\033[A\33[2K\r\033[A\33[2K\rError: Los primeros 9 caracteres del ISBN deben ser dígitos.\n";
            return false;
        }
    }
    ...
    if (!(isdigit(digitoControl) || digitoControl == 'X')) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El último carácter del ISBN debe ser un dígito o 'X'.\n";
        return false;
    }
...
bool Validaciones::validarIsbn13(const string& isbn) {
    if (isbn.size() != 13) {
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El ISBN debe tener 13 caracteres.\n";
        return false;
    }
    ...
    for (int i = 0; i < 13; i++) {
        if (!isdigit(isbn[i])) {
            cout << "\033[A\33[2K\r\033[A\33[2K\rError: Todos los caracteres del ISBN deben ser dígitos.\n";
            return false;
        }
    }
...
bool Validaciones::validarIsni(const string& isni) {
    ...
    if (isniSinEspacios.size() != 16) {
        std::cout << "\033[A\33[2K\r\033[A\33[2K\rError: El ISNI debe contener exactamente 16 caracteres (sin incluir espacios ni guiones).\n";
        return false;
    }

    // Verificar que los primeros 15 caracteres sean numéricos
    if (!std::all_of(isniSinEspacios.begin(), isniSinEspacios.end() - 1, ::isdigit)) {
        std::cout << "\033[A\33[2K\r\033[A\33[2K\rError: Los primeros 15 caracteres del ISNI deben ser numéricos.\n";
        return false;
    }
    ...
    if (!(std::isdigit(lastChar) || lastChar == 'X')) {
        std::cout << "\033[A\33[2K\r\033[A\33[2K\rError: El último carácter del ISNI debe ser un dígito o 'X'.\n";
        return false;
    }

    // Verificar que todos los caracteres no sean iguales
    if (all_of(isniSinEspacios.begin(), isniSinEspacios.end(), [isniSinEspacios](char c) { return c == isniSinEspacios[0]; })) {
        std::cout << "\033[A\33[2K\r\033[A\33[2K\rError: Ingrese un Isni Valido.\n";
        return false;
    }
...
bool Validaciones::validarTexto(const string& texto, const string& campo) {
    ...
    if (texto.empty() || texto.find_first_not_of(' ') == string::npos) {
        ...
        cout << "\033[A\33[2K\r\033[A\33[2K\rError: El campo " << campo << " solo debe contener letras, espacios y caracteres válidos en español.\n";
        return false;
    }
    return true;
}
